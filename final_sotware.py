...
def dataset_creation(parameters):
    ...
    if os.path.isdir(path):
        ...
        path = 'C:/Users/ameya/Deep learning/attendance_deep_learning/scripts_used/sample/output'
        if os.path.isdir(path):
            print("Directory already exists. Using it \n")
        else:
            if os.makedirs(path):
    ...
    # Create a session with specified GPU options
        sess =  tf.compat.v1.Session(config=tf.compat.v1.ConfigProto(gpu_options=gpu_options, log_device_placement=False))
        # Call create_mtcnn() with the model_path argument
...
def train(parameters):
    ...
    if model == "":
        model = "C:/Users/ameya/Deep learning/attendance_deep_learning/scripts_used/sample/20180402-114759/20180402-114759.pb"
    else:
        model += "C:/Users/ameya/Deep learning/attendance_deep_learning/scripts_used/sample/20180402-114759/20180402-114759.pb"
    ...
    # If image selected, go to image function.
        ...
        if path == "y":
            ...
            if os.path.isdir(path) or path == "":
                ...
                if path == "":
                    path = "C:/Users/ameya/Deep learning/attendance_deep_learning/scripts_used/sample/output_images"
                else:
                    path += 'C:/Users/ameya/Deep learning/attendance_deep_learning/scripts_used/sample/output_images'
                if os.path.isdir(path):
                    print("Directory already exists. Using it \n")
